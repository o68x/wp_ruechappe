...
function _ruechappe_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( '_ruechappe_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => '_ruechappe_header_style',
	) ) );
}
add_action( 'after_setup_theme', '_ruechappe_custom_header_setup' );

if ( ! function_exists( '_ruechappe_header_style' ) ) :
	/**
